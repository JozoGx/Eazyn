<!-- 
Fitur sql mengetahui jumlah izin pada setting: 
SELECT VALUE FROM SETTING WHERE nama_setting='pembatasan';

sql untuk mengetahui jumlah izin yang pernah disetujui:
select count(id) as jumlah_izin from izin where siswa_id = 2 and is_approved=2;
...
//var_dump($run_sql); //untuk debugging pake var_dump
?>
